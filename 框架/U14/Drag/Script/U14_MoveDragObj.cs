namespace U14.Drag
{
    ...
    public class U14_MoveDragObj : U14_BaseDragObj
    {
        ...
        protected virtual void SetConfData()
        {
            ...
            {
                maskLayerIdList = U14_DragData.instance.maskLayerIdList;
        ...
        protected override void OnBeginDragDelegate(PointerEventData data)
        {
            ...
            OnDragDelegate(data);
            EventUtil.DispatchEvent(DragMoveEventType.DragBegin, this.gameObject);
        }
        ...
        protected override void OnDragDelegate(PointerEventData data)
        {
            ...
            EventUtil.DispatchEvent(DragMoveEventType.DragMoving, this.gameObject);
        }
        ...
        protected override void OnEndDragDelegate(PointerEventData data)
        {
            ...
            EventUtil.DispatchEvent(DragMoveEventType.DragEnd, this.gameObject);
        }
